    ...
    $.ajaxloadmore = function (el, e) {
        ...
        alm.AjaxLoadMore.ajax = function (queryType) {
            ...
            // Standard ALM
                ...
                //   var owl = jQuery(".owl-demo3_dinamic_class").owlCarousel({
                //     items : 1,
                //     margin:10,
                //     nav:true,
                //     lazyLoad : true,
                //     beforeInit: countItems,
                //     navigation : false
                //   }); 
                scroller_call_dinamically(".nav_h_responsive_type");
                $.ajax({
                    type: 'GET',
                    ...
                    complete: function () {
                        ...
                        jQuery(".nav_h_responsive_type").each(function () {

                            console.log('owl_count');
                            scroller_call_dinamically(this);
                        ...
                        // console.log(alm.post_id);
                        // alert(alm.post__in);
                        // $.getScript("http://localhost/pvodf-robin/wp-content/themes/tootle-child/js/owl.start3.js", function() {
                    ...
                    if (total > 0) {
                        ...
                        setTimeout(function () {
                            $('.alm-paging-content', alm.el).fadeIn(alm.speed, 'alm_easeInOutQuad', function () {
                                ...
                                //console.log(alm.el.height() + paddingT + paddingB); 
        ...
        alm.AjaxLoadMore.triggerDone = function () {
            ...
            if (!alm.paging) {
                ...
                setTimeout(function () {
                    jQuery(".nav_h_responsive_type_y").each(function () {
                        scroller_call_dinamically_y(this);
                        // jQuery(this).owlCarousel({
                        //     items : 1,
                        //     padding: 40,
                        //     nav:true,
...
function scroller_call_dinamically(ccu) {
    console.log(ccu);
    jQuery(ccu).touchFlow({
        axis: "x",
        snap: true,
        scrollbar: false,
    });
...
function scroller_call_dinamically_y(ccu) {
    console.log('ccu333');
    console.log(ccu);
    jQuery(ccu).touchFlow({
        axis: "y",
...
function open_full_page(class_name, ccur) {
    jQuery('.' + class_name).css('height', 'unset');
    jQuery('.read_more_hide_option_' + ccur).css('display', 'none');
}