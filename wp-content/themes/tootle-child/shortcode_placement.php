...
//var_dump($a);
    ...
    ?>
<div class="top_story_front_home_page" style="width:<?php echo $a['width']?>;">
        <ul id="nav-tabs" class="nav nav-tabs flex-column flex-sm-row" role="tablist">
            <?php
            if(isset($a['title']) && $a['title']!=''){
            ?>
                <li class="flex-sm-fill text-center nav-item"><a class="nav-link active show" id="recent-tab" data-toggle="tab" role="tab" href="#tab-recent" aria-controls="recent" aria-selected="true"><?php echo $a['title'];?></a>
                </li>
            <?php } ?>
            <?php
            if(isset($a['link']) && $a['link']!='' && $a['link']!='#'){
            ?>
                <li class="flex-sm-fill text-center nav-item top_story">
                <a class="border_blank" id="" href="<?php echo $a['link'];?>"><small>SEE ALL</small></a>
                </li>
        <?php } ?>
        </ul>
    ...
    <div class="tab-content">	
             <div id="tab-recent" class="tab-pane fade active show" role="tabpanel" aria-labelledby="recent-tab">
                                                <?php
                                             //   echo $a['placement'];
                                                $meta_value = $a['placement']!='' ?$a['placement']:'top-stories';
                                                                    ...
                                                                    <ul>
                                                                            <?php
                                                                                    ...
                                                                                    while ($recent_posts->have_posts()): $recent_posts->the_post();?>
                                                                                        ...
                                                                                        ob_start();
                                                                                        ?>
                                                                                                                <a href="<?php the_permalink();?>"><?php echo custom_echo(get_the_title(),70);?></a>
                                                                                            <?php
  ...
  function card_type_with_meta_value_current($card_type, $insert_thumbnail_image, $insert_sponsors_content, $title_show, $author_insert, $time_due, $categories, $get_post_id, $i)
    {
        ...
        if ($i == 1) {
			...
			<div class="post-holder title_with_author title_with_author_in_same_line">
                <?php 
                echo $title_show;
               //echo  custom_echo($title_show , 150 ); 
                // if(strlen($title_show)<=150)
                // {
                //     echo  $title_show;
                // }
                // else
                // {
                //     echo  substr( $title_show, 0 , 150) . '...';
                //    // echo $y;
                // }
                ?>
				<div class="meta author_and_time">
