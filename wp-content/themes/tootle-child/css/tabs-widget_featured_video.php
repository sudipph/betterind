        ...
        if( $the_query->have_posts() ) {
            ...
            while ( $the_query->have_posts() ) { $the_query->the_post();
                ...
                if($video_slider_thumbnail=='true'){
                    ...
                    $output .= '<div class="col-12"><div class="video_content_with_date"><span class="video_title tab_widget_featured_video">'.$widget_ouput_template_params['{TITLE}'].'</span><span class="video_date">'.$widget_ouput_template_params['{DATE}'].'</span></div>';
