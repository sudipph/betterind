...
if ( ! function_exists( 'evolve_blog_page_content_new' ) ) {
	function evolve_blog_page_content_new() {
		...
		if ( have_posts() ) :
			...
			while ( have_posts() ) :
				the_post();
				get_template_part( 'template-parts/post/content_blog_page_content', 'post' );
			endwhile;
			...
			get_template_part( 'template-parts/post/content_blog_page_content', 'none' );
