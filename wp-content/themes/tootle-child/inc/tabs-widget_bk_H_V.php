...
echo $this->card_type_with_meta_value($gallery_data, $insert_thumbnail_image, $insert_sponsors_content, $insert_title, $author_insert, $time_due, $categories, $get_post_id);
...
function card_type_with_meta_value($card_type, $insert_thumbnail_image, $insert_sponsors_content, $title_show, $author_insert, $time_due, $categories, $get_post_id)
{
    ob_start();
