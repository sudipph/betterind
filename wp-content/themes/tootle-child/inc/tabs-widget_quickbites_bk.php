<?php
define('WIDGET_TITLE_QUICK', 'Quick Bytes ');
...
class RecentPostsPlus_quick extends WP_Widget {
    ...
    function form( $instance ) {
        ...
        <p><?php
        ?>
            <label for="<?php echo $this->get_field_id('count'); ?>"><?php _e('Number of Story Packages to show:'); ?></label> 
       ...
       <?php  /* <p>
        ...
        <p>
            ...
            <p><?php
        ?>
            <label for="<?php echo $this->get_field_id('subcount'); ?>"><?php _e('Number of Stories to show:'); ?></label> 
