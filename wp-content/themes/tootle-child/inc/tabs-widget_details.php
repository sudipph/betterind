...
class RecentPostsPlus_custom extends WP_Widget {
...
//add_action( 'admin_enqueue_scripts', array('RecentPostsPlus_custom', 'rpp_form_script') );

// register RecentPostsPlus widget
//add_action( 'widgets_init', create_function( '', 'return register_widget("RecentPostsPlus_custom");' ) );