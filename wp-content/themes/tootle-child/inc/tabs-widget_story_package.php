...
class RecentPostsPlus_story extends WP_Widget {
    ...
    function widget( $args, $instance ) {
        ...
        if(trim($title!='')){
                    echo '<div class="story_package_box">';
                    echo $before_widget;
    ...
    function parse_output($instance) {
        ...
        */
        ...
        $output ='<div class="row story_pack"><div class="story_package_see_all"><a class="border_blank" id=""  href="'. get_url_by_slug('story-package').'"><small>SEE ALL</small></a></div></div>';
      // echo $count;
       $param = 'taxonomy=story_package&type=post&hide_empty=0&number='.$count.'';
        ...
        if(count($category_list)>0){
            foreach($category_list as $key=>$value){
                ...
                $output .= $this->story_packages_front_design($value,$subcount,$f_parmalink);
            }
        }
       // 
        //var_dump($output);
...
<style>
        ...
        <p>
            ...
            <input class="widefat posts_title_validation" id="<?php echo $this->get_field_id('title'); ?>" name="<?php echo $this->get_field_name('title'); ?>" type="text" value="<?php echo $title; ?>" />
             <?php if($title==''){?> <div class="errors errors_title" >Title can't be blank.</div> <?php }else{
    ...
    function story_packages_front_design($param,$subcount=0,$link){
        global $wpdb, $post;
        ...
        $cat_name = get_term_meta( $cat_id, 'cat', true );
            ...
            ?>
            <div class="desktop_require_class">
                <div class="row">
                         <div id="tab-recent" class="tab-pane" role="tabpanel" aria-labelledby="recent-tab">
                            <?php if ( $image_id ){ ?>
                                ...
                                <div class="post-content" itemprop="mainContentOfPage">
                                    ...
                                    <div class="thumbnail-post">
                                        ...
                                        <!-- </a> -->
                                        <?php
                                        if(isset($cat_name) && $cat_name!='' && $cat_name!=-1){                                    
                                        ?>
                            ...
                            <div class="row col-12 text-right slide_box">
                                ...
                                if($total_stories>0){ 
                                    ...
                                    echo $total_stories;
                                    ?>
                                    Stories <span class="down_arrow force_click"><img width="20" src="<?php echo get_stylesheet_directory_uri();?>/images/down.png"></span>
                                ...
                                echo $total_stories;
                                    ?>
                                    Stories <span class="down_arrow force_click"><img width="16" src="<?php echo get_stylesheet_directory_uri();?>/images/down.png"></span>
                ...
                <?php
                if($total_stories>0){ ?>
                    <div class="row slide_box_selector_details background_image_from_admin" id="slide_box_selector_<?php echo $cat_id;?>">
                    <div class="background_image_from_shortcode_setup" style="background-image:url('<?php echo wp_get_attachment_image_url( $image_id, 'full' );?>');"></div>
                            <?php
                        $some_args = array(
                            'tax_query' => array(
                        ...
                        if( $total_post>0 ){
                                ...
                                // var_dump($p);
                                    ...
                                    <div class="row col-12">
                                        ...
                                        <div class="col-9">
                                            ...
                                            <div class="story_author <?php echo $subcount.' ';echo ($i==$subcount)?'no_border_for_story_pack':'';?>"> <span class="author_style"><?php echo date('j F, Y', strtotime($val->post_date));//echo the_author_meta( 'user_login' , $p->post_author );?></span>
                                            </div>
                                        </div>
                                    </div>
                                    <?php
                            ...
                            $i++;
                               ...
                               // if($subcount < $total_post){
                                    ...
                                    <?php 
                            if($link){?>
                            <a class="black_color" href="<?php echo $link;?>">Go To Story</a>
