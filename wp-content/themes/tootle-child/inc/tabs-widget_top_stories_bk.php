<?php
//top stories
register_widget('evolve_Tabs_Widget_tops');

class evolve_Tabs_Widget_tops extends WP_Widget
{
...
if ($orderby == 'Highest Comments') {
    ...
    $insert_title = ob_get_clean();
            ...
            echo $this->card_type_with_meta_value($gallery_data, $insert_thumbnail_image, $insert_title, $author_insert, $time_due, $categories);
...
echo $after_widget;
    ...
    public function card_type_with_meta_value($card_type, $insert_thumbnail_image, $title_show, $author_insert, $time_due, $categories)
    {
		...
		<div class="col-12 sponsors_body">
			In Association with <span class="sponsors_title"> <img src="<?php echo $sponsors_url; ?>" width="100"><!--<?php echo $sponsors ?> <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/right_blue.png" width="12">--></span>
		</div>
		<?php
}
