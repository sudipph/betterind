<?php
//top stories
register_widget('evolve_Tabs_Widget_presponsive');

class evolve_Tabs_Widget_presponsive extends WP_Widget
{

    public function __construct()
    {
        parent::__construct(
            'evolve_tabs-widget-placement',
            __('Placement Item(3)', 'evolve'), // Name
            array(
                'classname' => 'evolve_tabs',
                'description' => __('Three Placement Item.', 'evolve'),
            ) // Args
        );
    }
    ...
    public function widget($args, $instance)
    {
        ...
        // echo $tags_count;
        // echo $posts_title;
        if(trim($posts_title)!='' && $tags_count!='-1'){
