<?php
define('SOLUTION_IMAGE_FIELD', 'solutions_library');
if (!class_exists('Showcase_Taxonomy_Images')) {
  class Solutions_Taxonomy_Images
  {
    ...
    public function init()
    {
     // Image actions
     // echo 'hello';
      add_action(SOLUTION_IMAGE_FIELD . '_add_form_fields', array($this, 'add_category_image'), 10, 2);
      add_action('created_' . SOLUTION_IMAGE_FIELD, array($this, 'save_category_image'), 10, 2);
      add_action(SOLUTION_IMAGE_FIELD . '_edit_form_fields', array($this, 'update_category_image'), 10, 2);
      add_action('edited_' . SOLUTION_IMAGE_FIELD, array($this, 'updated_category_image'), 10, 2);
    ...
    {
      if (!isset($_GET['taxonomy']) || $_GET['taxonomy'] != SOLUTION_IMAGE_FIELD) {
        return;
      }
      wp_enqueue_media();
    }
...
$Solutions_Taxonomy_Images = new Solutions_Taxonomy_Images();
$Solutions_Taxonomy_Images->init();
}