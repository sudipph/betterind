<?php
define('WIDGET_TITLE_DYNAMIC', 'Dynamic Post');
define('WIDGET_TITLE_DYNAMIC_SLUG', 'recent-posts-plus-dpost');

class RecentPostsPlus_dinamic extends WP_Widget {
    ...
    function __construct() {
        ...
        parent::__construct(WIDGET_TITLE_DYNAMIC_SLUG, __(WIDGET_TITLE_DYNAMIC), $widget_ops);
    }
...
add_action( 'admin_enqueue_scripts', array('RecentPostsPlus_dinamic', 'rpp_form_script') );
//add_action( 'wp_enqueue_scripts',  'front_rpp_form_script');


add_action( 'widgets_init', 'create_widget_function_dynamic' );

function create_widget_function_dynamic(){
    register_widget("RecentPostsPlus_dinamic");
}
