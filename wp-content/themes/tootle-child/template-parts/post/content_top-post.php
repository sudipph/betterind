...
<article id="post-<?php the_ID();?>" <?php post_class('content-post content_post_'.(isset($ki)?$ki:$ki));?> itemscope="itemscope" itemtype="http://schema.org/BlogPosting" itemprop="blogPost">
