...
?>
						<div class="row post-meta align-items-center topstories_post">
							...
							<div class="author vcard">
							    ...
							    <div class="share_beside_author topstories_post disable_in_desktop_unique"><?php share();?></div>
							</div>

						</div>
</div>
<div class="main_content top_story_width_change top_story_table_unique">
    <div class="inner_content_width_slider show_only_desktop top_story_table_cell_unique">
...
<div class="inner_content_width top_story_table_cell_unique" >
						<?php
    ...
    echo change_first_content($full_html);
    // the_content();
    }
    ...
    ?>
    <div class="share_button topstories_share_button_unoque"><?php echo do_shortcode('[Sassy_Social_Share] ') ?></div>
    </div>

<div class="right_share_button show_only_on_desktop top_story_table_cell_unique">
