...
<article  id="post-<?php the_ID();?>" <?php post_class('tbi_corner_article_loop');?> itemscope="itemscope" itemtype="http://schema.org/BlogPosting" itemprop="blogPost">
<div class="row">
<!-- <div class="col-12"> -->
	<?php
...
?>
	<div class="row">
                        ...
                        <span class="written_by"> by </span><span class="written_by_con"><?php echo get_the_author(); ?></span>
...
//the_title('<h1 class="post-title-display tbi_corner_title" itemprop="name" id>', '</h1>');
echo '<h1 class="post-title-display tbi_corner_title" itemprop="name" id>';
echo custom_echo(get_the_title(),110);
echo '</h1>';
