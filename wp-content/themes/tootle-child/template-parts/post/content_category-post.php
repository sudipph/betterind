...
<article  id="post-<?php the_ID();?>" <?php  echo $border_button;  post_class($class_helper.' content-post content_post_'.(isset($ki)?$ki:$ki));?> itemscope="itemscope" itemtype="http://schema.org/BlogPosting" itemprop="blogPost">
...
if($ki!=$total_post_count){
?>
<div class="row next_bar_border content_category_post" style="margin-top: 6vh;"><div class="next_post_border">Next Post</div></div>
<?php
}
$ki++;
?>
